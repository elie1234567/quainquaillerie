<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">quainqualerieI</span>
        </a>
    </div>
    <div style="display: flex; align-items: start;">
    <img src="{{ asset('images/zany.png') }}" width="50" height="50" style="border-radius: 60px;">
    <span style="margin-left: 10px; position: relative; top: 10px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-size: 18px; color: yellow;">
        @if(Auth::check() && Auth::user())
            {{ Auth::user()->name }}
        @endif
        @if(Auth::guard('admin')->check() && Auth::guard('admin')->user())
            ,{{ Auth::guard('admin')->user()->nomA }}
        @endif
    </span>
</div>
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('loginAdmin') ? 'active' : '' }}" href="{{ route('loginAdmin') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('wallet') ? 'active' : '' }} " href="{{ route('wallet') }}">
                    ...
                    <span class="nav-link-text ms-1">revenu et statistique</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('RTL') ? 'active' : '' }}" href="{{ route('RTL') }}">
                    ...
                    <span class="nav-link-text ms-1">faire le commande</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">options</span>
                </div>
            </li>
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">autre Pages</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('pro') ? 'active' : '' }}"
                    href="{{ route('pro') }}">
                    <span class="nav-link-text ms-1">fournisseurs</span>
                </a>
            </li>
    ...
    <div class="collapse navbar-collapse px-4 w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <!-- Navigation Item for Messenger -->
        <li class="nav-item">
            <a class="nav-link {{ is_current_route('/chatify') ? 'active' : '' }}" href="/chatify">
                <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <!-- SVG Icon for Messenger -->
                    <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>crm</title>
                        <g id="dashboard" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
