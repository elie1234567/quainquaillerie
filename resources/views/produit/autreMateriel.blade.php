<x-app-layout>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4 px-5">
            <div class="row">
                <div class="col-12">
                    <div class="card card-background card-background-after-none align-items-start mt-4 mb-5">
                        <div class="full-background" style="background-image: url('../assets/img/image-sign-in.jpg')"></div>
            ...
            <div class="container">
                <h1 id="ewa" style="text-align: center;"> 🪒matériels autres 🪒</h1>
                <br><br><br>
                ...
                <div class="card-deck">
                    ...
                    <div class="card" id="el">
                        <img class="card-img-top" style="height: 290px; width: 290px;" src="data:image/jpeg;base64,{{ base64_encode($value->imagep) }}" alt="Image electrique">
                        <div class="card-body">
                             <h5 class="card-title">{{ $value->idp }}</h5>
                            <h5 class="card-title">{{ $value->articlep }}</h5>
                            <p class="card-text">Quantité: {{ $value->quantitep }}</p>
                            <p class="card-text">Prix: {{ $value->prixep }}</p>
                            <button type="button" 
                                        class="btn btn-success btn-edit"
                                         data-id="<?php echo e($value->idp); ?>"
                                         data-name="<?php echo e($value->articlep); ?>"
                                         data-email="<?php echo e($value->quantitep); ?>"
                                        data-phone="<?php echo e($value->prixep); ?>"
                                        data-location="<?php echo e($value->imagep); ?>">
                                        commande
                            </button>
...
<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="editUserForm" action="{{ route('storeautres') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <input type="number" name="quantiteP" id="quantiteP" class="form-control">
