<x-app-layout>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="container">
                <h1 id="ewa" style="text-align: center;">🚕 voiture matériels 🚕</h1>
                <br><br><br>
                ...
                <div class="card-deck">
                    ...
                    <div class="card" id="el">
                        <img class="card-img-top" style="height: 290px; width: 290px;" src="data:image/jpeg;base64,{{ base64_encode($value->imagev) }}" alt="Image electrique">
                        <div class="card-body">
                             <h5 class="card-title">{{ $value->idv }}</h5>
                            <h5 class="card-title">{{ $value->articlev }}</h5>
                            <p class="card-text">Quantité: {{ $value->quantitev }}</p>
                            <p class="card-text">Prix: {{ $value->prixev }}</p>
                            <button type="button" 
                                        class="btn btn-success btn-edit"
                                         data-id="<?php echo e($value->idv); ?>"
                                         data-name="<?php echo e($value->articlev); ?>"
                                         data-email="<?php echo e($value->quantitev); ?>"
                                        data-phone="<?php echo e($value->prixev); ?>"
                                        data-location="<?php echo e($value->imagev); ?>">
                                        commande
                            </button>
...
<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="editUserForm" action="{{ route('storevoiture') }}" method="POST">
                @csrf
